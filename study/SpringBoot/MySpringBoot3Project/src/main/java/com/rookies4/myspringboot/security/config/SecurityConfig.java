...
public class SecurityConfig {
    ...
    //커스터마이징한 UserDetailsService 인터페이스를 구현한 객체를 Bean으로 설정하기
    @Bean
...
//    @Bean
//    //authentication(인증)을 위한 User 생성 (관리자, 일반 사용자)
